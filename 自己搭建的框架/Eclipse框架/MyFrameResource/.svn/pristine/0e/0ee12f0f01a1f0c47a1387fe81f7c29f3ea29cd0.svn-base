package com.alnton.myFrameResource.util.calendar;
...
import com.alnton.myFrameResource.util.calendar.KCalendar.OnCalendarClickListener;
import com.alnton.myFrameResource.util.calendar.KCalendar.OnCalendarDateChangedListener;
...
public class CalendarPopupWindows extends PopupWindow
{
    ...
    public CalendarPopupWindows(Context mContext, View parent)
    {
        ...
        calendar.setOnCalendarClickListener(new OnCalendarClickListener()
        {
            ...
            {
                int month =
                    Integer.parseInt(dateFormat.substring(dateFormat.indexOf("-") + 1, dateFormat.lastIndexOf("-")));
        ...
        RelativeLayout popupwindow_calendar_last_month =
            (RelativeLayout)view.findViewById(R.id.popupwindow_calendar_last_month);
        ...
        RelativeLayout popupwindow_calendar_next_month =
            (RelativeLayout)view.findViewById(R.id.popupwindow_calendar_next_month);
