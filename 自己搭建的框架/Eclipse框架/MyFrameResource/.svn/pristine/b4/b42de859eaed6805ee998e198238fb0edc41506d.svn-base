...
public class PullToRefreshListFooter extends LinearLayout
{
    ...
    public void setState(int state)
    {
        ...
        if (state == STATE_READY)
        {
            ...
            mContentView.setText(R.string.xlistview_footer_hint_ready);
        }
        ...
        {
            mContentView.setVisibility(View.VISIBLE);
            mContentView.setText(R.string.load_more);
        }
    }
    ...
    private void initView(Context context)
    {
        ...
        mContentView = (TextView)moreView.findViewById(R.id.listview_foot_more);
        mProgressBar = (ProgressBar)moreView.findViewById(R.id.listview_foot_progress);
    }
}