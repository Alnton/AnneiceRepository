package com.alnton.myFrameResource.view.EditText;
...
/**
 * 自定义输入框 左边出现图标 右边出现删除按钮操作控制
 * @author  詹海
 * @createon 2016-9-22
 */
public class ClearEditText extends EditText implements TextWatcher, android.view.View.OnFocusChangeListener
{
    /**
     * 左右两侧图片资源
     */
            ...
            switch (event.getAction())
            {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if ((getWidth() - xUp) <= getCompoundPaddingRight()
                        && (getWidth() - xDo) <= getCompoundPaddingRight())
                    {
