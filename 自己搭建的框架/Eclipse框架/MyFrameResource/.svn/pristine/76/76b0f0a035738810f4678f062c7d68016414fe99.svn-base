 ...
 */
public class NoScrollSwipeListView extends ListView
{
    /**
     ...
     */
    private NoScrollSwipeListViewTouchListener touchListener;
    
    /**
     * 如果外面有ViewPager嵌套 防止滑动冲突
     */
     ...
     *            Front Identifier
     */
    public NoScrollSwipeListView(Context context, int swipeBackView, int swipeFrontView)
    {
        super(context);
    ...
    private void init(AttributeSet attrs)
    {
        ...
        if (swipeFrontView == 0 || swipeBackView == 0)
        {
            ...
            swipeBackView =
                getContext().getResources().getIdentifier(SWIPE_DEFAULT_BACK_VIEW, "id", getContext().getPackageName());
            
            if (swipeFrontView == 0 || swipeBackView == 0)
            {
                throw new RuntimeException(
                    String.format("You forgot the attributes swipeFrontView or swipeBackView. You can add this attributes or use '%s' and '%s' identifiers",
        ...
        touchListener = new NoScrollSwipeListViewTouchListener(this, swipeFrontView, swipeBackView);
    ...
    public void setViewPager(ViewPagerCompat myViewPager)
    {
