...
public class ChoicePayTypeActivity extends BaseActivity implements OnClickListener
{
    ...
    private void getPayType()
    {
        ...
        RequestCallback<PayType> req =
            new RequestCallback<PayType>(mContext, true, false, new TypeToken<ResponseEntity<PayType>>()
            {
            }.getType())
            {
                
                @Override
                public void onSuccess(ArrayList<PayType> listInfo)
                {
                    super.onSuccess(listInfo);
                    
                    for (PayType type : listInfo)
                    {
        ...
        HttpInterface.instance.onPostWithJson(mContext, URLConfig.PAYTYPE_URL, params, req);
    }
    ...
    private void wxPayByfuzhong()
    {
        ...
        HttpInterface.instance.onPostWithJson(mContext, URLConfig.WXPAY_URL, params, new RequestCallback<PayInfo>(
            mContext, new TypeToken<ResponseEntity<PayInfo>>()
            {
            }.getType())
        {
            @Override
            public void onSuccess(PayInfo info)
            {
                ...
                {
                    MyframeTools.getInstance().showDialogCenterOneButton(mContext,
    ...
    private void pay()
    {
        switch (flag)
        {
            ...
            case 2:
                ...
                HttpInterface.instance.onPostWithJson(mContext, URLConfig.YINLIANPAY_URL, params, new RequestCallback<PayInfo>(
                    mContext, new TypeToken<ResponseEntity<PayInfo>>()
                    {
                    }.getType())
                {
    ...
    //        MyFrameResourceTools.getInstance().startActivity(mContext, PaySuccessActivity.class, bundle);
        ...
        {
            MyframeTools.getInstance().showDialogCenterOneButton(mContext, ChoicePayTypeActivity.this, "支付失败！");
        }
        else if (str.equalsIgnoreCase("cancel"))
        {
            MyframeTools.getInstance().showDialogCenterOneButton(mContext, ChoicePayTypeActivity.this, "你已取消了本次订单的支付！");
        }
    }
    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
            ...
            case R.id.alipayLayout:
                ...
                if (0 == flag)
                {
                    alipayImageView.setImageResource(R.drawable.uncheck);
                    flag = -1;
                }
                else
                {
                    wxImageView.setImageResource(R.drawable.uncheck);
                    yinlianImageView.setImageResource(R.drawable.uncheck);
                    
                    alipayImageView.setImageResource(R.drawable.check);
                    flag = 0;
                }
                break;
            ...
            case R.id.wxLayout:
                ...
                else
                {
                    ...
                    wxImageView.setImageResource(R.drawable.check);
                    flag = 1;
                }
                break;
            ...
            case R.id.yinlianLayout:
                ...
                else
                {
                    ...
                    yinlianImageView.setImageResource(R.drawable.check);
                    flag = 2;
                }
                break;
    ...
    {
        MyframeTools.getInstance().showDialogCenter(mContext,
            R.layout.dialog_xml,
            ChoicePayTypeActivity.this,
            "是否放弃本次支付?");
    }
