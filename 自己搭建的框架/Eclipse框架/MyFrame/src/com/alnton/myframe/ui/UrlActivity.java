...
public class UrlActivity extends BaseActivity implements OnClickListener
{
    ...
    BroadcastReceiver urlProgressReceiver = new BroadcastReceiver()
    {
        ...
        {
            if (FusionCode.getInstance().HAPPY_URL_RECEIVER.equals(intent.getAction()))
            {
    ...
    private void initView()
    {
        ...
        this.registerReceiver(urlProgressReceiver, new IntentFilter(FusionCode.getInstance().HAPPY_URL_RECEIVER));
        ...
        webView.setWebChromeClient(new WebChromeClient()
        {
            ...
            {
                Intent intent = new Intent(FusionCode.getInstance().HAPPY_URL_RECEIVER);
