package com.alnton.myframecore.view.Swipe;
...
import com.alnton.myframecore.view.Swipe.adapter.CommonString;
import com.alnton.myframecore.view.Swipe.adapter.ContactAdapter;
import com.alnton.myframecore.view.Swipe.adapter.expandRecyclerviewadapter.StickyRecyclerHeadersDecoration;
import com.alnton.myframecore.view.Swipe.model.ContactModel;
import com.alnton.myframecore.view.Swipe.pinyin.CharacterParser;
import com.alnton.myframecore.view.Swipe.pinyin.PinyinComparator;
import com.alnton.myframecore.view.Swipe.widget.DividerDecoration;
import com.alnton.myframecore.view.Swipe.widget.SideBar;
import com.alnton.myframecore.view.Swipe.widget.SwipeRecyclerView;
...
public class DemoRecyclerViewActivity extends Activity {
    ...
    private void initView() {
        ...
        mRecyclerView = (SwipeRecyclerView) findViewById(R.id.contact_member);
    ...
    private void setUI() {
        ...
        if (mAdapter == null) {
            ...
            mRecyclerView.addItemDecoration(new DividerDecoration(this,layoutManager.getOrientation()));
