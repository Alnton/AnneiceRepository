package com.alnton.myframecore.view.Tab;
...
import com.alnton.myframecore.adapter.tab.TabAdapter;
...
//                            gridActivity.tabOnClick(contacts.getIndex());
            ...
            this.addView(view, new LayoutParams(width, LayoutParams.WRAP_CONTENT));
        }
    }
}