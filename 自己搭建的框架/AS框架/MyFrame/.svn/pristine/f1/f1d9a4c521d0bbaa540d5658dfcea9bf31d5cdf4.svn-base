...
import com.alnton.myframe.ui.pay.alipay.AlipayConstants;
                    ...
                    switch (flag) {
                        case 0:
                            ...
                            Map<String, String> params =
                                    AlipayUtil.getInstance().buildOrderParamMap(AlipayConstants.APP_ID,
                            ...
                            String sign = AlipayUtil.getInstance().getSign(params, AlipayConstants.PRIVATE_KEY);
