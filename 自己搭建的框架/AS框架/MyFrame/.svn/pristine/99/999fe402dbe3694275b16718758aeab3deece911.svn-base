...
package com.alnton.myframecore.view.Swipe.adapter;
...
import com.alnton.myframecore.view.Swipe.DemoRecyclerViewActivity;
import com.alnton.myframecore.view.Swipe.adapter.expandRecyclerviewadapter.StickyRecyclerHeadersAdapter;
import com.alnton.myframecore.view.Swipe.model.ContactModel;
import com.alnton.myframecore.view.Swipe.widget.SwipeItemLayout;
 ...
 * 根据当前权限进行判断相关的滑动逻辑
 */
public class ContactAdapter extends BaseRecyclerViewContactAdapter<ContactAdapter.ContactViewHolder>
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.demo_recyclerview_contact_item, parent, false);
        ...
        if (getItem(position).getId().equals(OWNER)) {
            ...
            holder.mDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DemoRecyclerViewActivity demoRecyclerViewActivity = (DemoRecyclerViewActivity) mContext;
                    demoRecyclerViewActivity.deleteUser(position);
                }
            });
        } else {
                    ...
                    if (getItem(position).getProfession().equals(STUDENT)) {
                        ...
                        holder.mDelete.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                ((DemoRecyclerViewActivity) mContext).deleteUser(position);
                            }
                        });
                    } else {
                        swipeRoot.setSwipeAble(false);
    ...
    public RecyclerView.ViewHolder onCreateHeaderViewHolder(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.demo_recyclerview_contact_header, parent, false);
