package com.alnton.myframecore.view.slidingmenu;
...
import com.alnton.myframecore.view.slidingmenu.SlidingMenu.OnClosedListener;
import com.alnton.myframecore.view.slidingmenu.SlidingMenu.OnOpenedListener;
