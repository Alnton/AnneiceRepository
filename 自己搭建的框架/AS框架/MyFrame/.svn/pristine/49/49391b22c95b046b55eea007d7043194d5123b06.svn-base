package com.alnton.myframecore.view.PictureFlow;
...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    public void setRefreshLayout(RefreshLayout myRefreshLayout) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                // 如果ViewFlow正在拖拽中，那么设置myRefreshLayout不启动下拉刷新
                if (mIsVpDragger) {
                    if (null != myRefreshLayout) {
                ...
                // 如果X轴位移大于Y轴位移，那么设置myRefreshLayout不启动下拉刷新
    ...
    private View setupChild(View child, boolean addToEnd, boolean recycle) {
        ...
        if (p == null) {
            p =
                    new AbsListView.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT, 0);
        }
        if (recycle)
